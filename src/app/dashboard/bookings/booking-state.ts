 ...
 * halaman ini) dan TANPA payment_url (payload QRIS mentah, tidak berguna
 * bagi merchant). merchant_id juga dibuang karena tidak pernah dirender.
 */
export type BookingListItem = Omit<Booking, "merchant_id" | "access_token" | "payment_url">;
 ...
 * Kalau field BookingListItem berubah, daftar ini WAJIB ikut disesuaikan.
 */
